import app from"/js/site.min.js";import route from"/js/router.min.js";const d=app.d,df=d.domfn,{div:div,input:input,button:button,article:article,a:a,p:p,hr:hr,h1:h1,h4:h4,section:section,span:span,header:header}=df,mainView=d.query("main[route-active]"),postListView=div({class:"post-list"}),contentDisplay=section({class:"posts"},postListView);app.postDisplay=section({class:"full post"},t=>{t.parts=d.h`
